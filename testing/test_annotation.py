...
class MaximumLikelihoodAncestralAnnotationTestCase(TestCase):
    ...
    @requires('resources/EST-SFS/test-betula-biallelic-10000.txt')
    ...
    @requires('resources/genome/betula/all.with_outgroups.subset.10000.vcf.gz', 'resources/genome/betula/genome.subset.20.fasta')
    @pytest.mark.slow
