...
class ParserTestCase(TestCase):
    ...
    @requires('resources/genome/betula/biallelic.polarized.vcf.gz', 'resources/genome/betula/pops_dadi.txt')
    @staticmethod
    @pytest.mark.slow
    ...
    @requires('resources/genome/betula/all.polarized.vcf.gz', 'resources/genome/betula/genome.fasta', 'resources/genome/betula/genome.gff.gz')
    @pytest.mark.slow
