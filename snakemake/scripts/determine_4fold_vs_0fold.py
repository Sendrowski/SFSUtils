...
p = sf.Parser(
    ...
    stratifications=[sf.DegeneracyStratification()],  # stratify by 4-fold and 0-fold sites
    annotations=[sf.DegeneracyAnnotation()],  # annotate sites with degeneracy on-the-fly
