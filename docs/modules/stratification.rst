.. _modules.stratification:

Site stratification
-------------------

A :class:`~sfsutils.parser.Stratification` splits sites into categories so the :class:`~sfsutils.parser.Parser` counts a separate spectrum per stratum, for instance neutral versus selected sites.
