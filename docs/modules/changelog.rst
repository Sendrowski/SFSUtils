...
- Two-site (two-locus) site-frequency spectra via ``two_sfs``, returned as a :class:`~sfsutils.spectrum.SFS2`.
...
- R plotting for :class:`~sfsutils.spectrum.SFS2` and :class:`~sfsutils.spectrum.JointSFS`, and a mirrored R documentation reference.
