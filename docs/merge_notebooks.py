...
``snakemake/results/docs/Python/{name}.executed.ipynb`` and ``snakemake/results/docs/R/{name}.executed.ipynb``, with
the resolution ``DOCS_FIGURE_DPI`` of the Snakefile. Run directly, ``python docs/merge_notebooks.py <dpi> <name> ...`` does the same
...
if __name__ == "__main__":
    try:
        ...
        jobs = [(results / "Python" / f"{name}.executed.ipynb", results / "R" / f"{name}.executed.ipynb",
